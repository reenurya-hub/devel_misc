...
//
    ...
    void buscar_mayor_vector_ini(){
        ...
        cout << "Mayor primer loop = " << mayor << endl;
        //
        ...
        i=0;
        //segunda pasada se debe optimizar
        mayor = 0;
        do{
            if(vec_temp[i]>= mayor){
                mayor = vec_temp[i];
        ...
        // para no volver a tomar ese valor
        vec_temp[idx_mayor] = 0;
        cout << "Mayor segundo loop = " << mayor << endl;
        // empieza a llenar vec_orden
        for(i=0;i<=2;i++){
            if(vec_orden[i]==0){
                vec_orden[i] = mayor;
        ...
        // para no volver a tomar ese valor
        vec_temp[idx_mayor] = 0;
        cout << "Mayor tercer loop = " << mayor << endl;
        // empieza a llenar vec_orden
        for(i=0;i<=2;i++){
            if(vec_orden[i]==0){
                vec_orden[i] = mayor;
...
int main()
{
    ...
    imprime_vector(vector);
    //
    cout << "hasta aqui inserta valores en vector. " << endl;
    cout << "AHORA VOY A CREAR UN ARRAY TEMPORAL. " << endl;
    cout << "vec_temp : " << endl;
    dimension = 2;
