       ...
       SELECT LFSALES  ASSIGN TO "SALES.DAT"
           ORGANIZATION IS LINE SEQUENTIAL.

       SELECT LFSALESREP ASSIGN TO "LFSLSREP.DAT"
           ORGANIZATION IS LINE SEQUENTIAL.
      ...
      * FIELDS TO STORE LOOP AND VALUES FOR EACH ITERATION OF PERFORM.
       01  WS-FIELDS.
      ...
      * THE FOLLOWING CODE DEFINES STRUCTURE OF THE SALES REPORT:
      * HEADER REPORT
       01  HEADING-LINE.
            05 FILLER           PIC X(20).
            05 FILLER           PIC X(34)
      ...
      * DETAIL REPORT
       01  DETAIL-LINE.
        ...
        01  DETAIL-SUBTOTAL-LINE1.
            05 FILLER                           PIC X(20) VALUE SPACES.
            05 DET-NAME                         PIC X(40) VALUE SPACES.
      ...
      * WRITE HEADER OF REPORT
       ...
       0200-PROCESS-ITEMS.
      * INITIALIZE COUNTER AND VARIABLE VALUES TO ITERATION
           MOVE 1 TO WS-INDEX.
           MOVE 0 TO WS-ITEM-SUBTOTAL, WS-SUBTOT-QUANT.
           MOVE CUSTOMER-NAME TO DET-NAME.
      * PERFORM THE TIMES OF BUY FOR CUSTOMER
           PERFORM 3 TIMES
